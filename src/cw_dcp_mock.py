...
class CodewerkDCP:
    def __init__(self, ip):
        ...
        self.src_mac, self.iface = self.__get_nic()
        self.s = scapy.conf.L2socket(iface=self.iface)
        self.s = Mock()
        self.frame = None
        self.service = None
    ...
    def __get_nic(self):
        ...
        '''
        psutil = Mock()
        psutil.net_if_addrs.return_value = self.mock.testnetz
    ...
    def read_response(self, to=20, once=False, debug=True, get=False, set=False):
        ...
        ret = {}
        found = []
        self.s.recv.return_value = self.mock.identify_response(self.s.request)
